...
Ordena y fusiona tus documentos PDF mediante esta aplicacion en local, sin exponer a la red tus documentos. 
...
git clone https://github.com/noclastic/sutura
cd project
...
Si tienes algún problema o sugerencia, por favor abre un issue [aquí](https://github.com/noclastic/sutura/issues).
...
- **Roberto Getino** - [Roberto Getino](https://github.com/brayandiazc)
...
Copyright (c) 2026 Roberto Getino Garcia

This software is provided for personal and educational use only.
Commercial use, distribution for profit, or selling this software
or any derived work is not permitted without explicit permission
from the author.
